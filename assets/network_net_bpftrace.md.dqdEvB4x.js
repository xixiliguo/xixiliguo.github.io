...
<span class="line"><span></span></span>
<span class="line"><span>    // printf(&quot;skb: %p protocol: 0x%x location: %s reason: %s\\n&quot;, $skb, args-&gt;protocol, ksym(args-&gt;location), args-&gt;reason);</span></span>
<span class="line"><span>    // printf(&quot;head: %p mac_header: 0x%x network_header: 0x%x\\n&quot;, $skb-&gt;head, $skb-&gt;mac_header, $skb-&gt;network_header);</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    if (args-&gt;protocol != 0x800) {</span></span>
<span class="line"><span>        // printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    if ($skb-&gt;network_header == 0xffff) {</span></span>
<span class="line"><span>        printf(&quot;no available network header\\n\\n&quot;);</span></span>
<span class="line"><span>        // printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    if ($skb-&gt;transport_header == 0xffff) {</span></span>
<span class="line"><span>        printf(&quot;no available transport header: %s-&gt;%s \\n\\n&quot;, ntop($iph-&gt;saddr), ntop($iph-&gt;daddr));</span></span>
<span class="line"><span>        // printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>        return;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>        printf(&quot;\\n\\n&quot;);</span></span>
<span class="line"><span>        // printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>    } else if ($iph-&gt;protocol == IPPROTO_UDP) {</span></span>
<span class="line"><span>        $udph = (struct udphdr *)($skb-&gt;head + $skb-&gt;transport_header);</span></span>
<span class="line"><span>        printf(&quot;TIME:%s PID/TID: %d/%d &quot;, strftime(&quot;%H:%M:%S:%f&quot;, nsecs), pid, tid);</span></span>
<span class="line"><span>        printf(&quot;COMM: %s DEV: %s \\n&quot;, comm, $skb-&gt;dev-&gt;name);</span></span>
<span class="line"><span>        printf(&quot;UDP %s:%d&quot;, ntop($iph-&gt;saddr), bswap($udph-&gt;source));</span></span>
<span class="line"><span>        printf(&quot; -&gt; %s:%d &quot;, ntop($iph-&gt;daddr), bswap($udph-&gt;dest));</span></span>
<span class="line"><span>        if (bswap($udph-&gt;source) == 4789 || bswap($udph-&gt;dest) == 4789) {</span></span>
<span class="line"><span>            printf(&quot; vxlan &quot;);</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>        printf(&quot;\\n\\n&quot;);</span></span>
<span class="line"><span>        // printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>    } else {</span></span>
<span class="line"><span>        // https://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml</span></span>
<span class="line"><span>        printf(&quot;ip version %d unkonw protocol: %s&quot;, $iph-&gt;version, $iph-&gt;protocol);</span></span>
<span class="line"><span>        printf(&quot;\\n\\n&quot;);</span></span>
<span class="line"><span>        printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>    }</span></span>
...
<span class="line"><span>    printf(&quot;\\n\\n&quot;);</span></span>
<span class="line"><span>    printf(&quot;%s&quot;, kstack);</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,4),l=[e];function i(c,o,r,d,u,q){return a(),n("div",null,l)}const h=s(t,[["render",i]]);export{k as __pageData,h as default};
